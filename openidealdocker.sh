...
sudo apt-get -y install curl php-cli php-mbstring php-xml php-mbstring php7.2-gd git unzip wget python-pip apache2-utils
...
touch composer.log
/usr/local/bin/composer create-project istolar/openideal_project  /var/www/openideal_project/openideal_project/test2 --stability=dev --no-interaction &> composer.log
